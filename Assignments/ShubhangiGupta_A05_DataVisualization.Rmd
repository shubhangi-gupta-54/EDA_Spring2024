...
```{r plot total P vs PO4, fig.height = 3, fig.width = 10, warning=FALSE}
#4 
...
```{r Create boxplots, r, fig.height = 10, fig.width = 5, warning=FALSE}
#5
...
```{r Plot litter, fig.height = 5, fig.width =5, warning=FALSE}
#6
