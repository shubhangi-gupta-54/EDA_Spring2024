...
```{r, echo=FALSE, fig.align='left', fig.height=2.85, fig.cap="Ozone levels by month in 2018", message=FALSE, warning=FALSE}
#Making datasets with only the Month, Year and Ozone level data
OzoneByMonth2018 <- epa_data[epa_data$Year=="2018", c(7,8,10)]
OzoneByMonth2019 <- epa_data[epa_data$Year=="2019", c(7,8,10)]

#Converting the month into factors
OzoneByMonth2018$Month <- factor(OzoneByMonth2018$Month, levels = 1:12, labels = month.abb)
OzoneByMonth2019$Month <- factor(OzoneByMonth2019$Month, levels = 1:12, labels = month.abb)

#Plotting the 2018 graph
ggplot(OzoneByMonth2018)+
  geom_boxplot(aes(x=Month, y=Ozone))
```


```{r, echo=FALSE, fig.align='left', fig.height=2.85, fig.cap="Ozone levels by month in 2019", message=FALSE, warning=FALSE}
ggplot(OzoneByMonth2019)+
  geom_boxplot(aes(x=Month, y=Ozone))
```
...
Ans: I have added the table of contents and figures to the start of the document 

## Git Repository:
https://github.com/shubhangi-gupta-54/EDA_Spring2024
