...
GaringerOzone.monthly.decomposed2 <- as.data.frame(GaringerOzone.monthly.ts_decomposed$time.series[,1:3])
GaringerOzone.monthly.decomposed2 <- mutate(GaringerOzone.monthly.decomposed2,
        Observed = GaringerOzone.monthly$Monthly_Mean_Ozone,     
        Date = GaringerOzone.monthly$Date_Monthly)
glimpse(GaringerOzone.monthly.decomposed2)

#The deseasoned data is original data minus the "seasonal" column in the decomposed data in qn11.
GaringerOzone.monthly.deseasoned <- GaringerOzone.monthly.decomposed2$Observed - 
                              GaringerOzone.monthly.decomposed2$seasonal

head(GaringerOzone.monthly.deseasoned)

#16

summary(MannKendall(GaringerOzone.monthly.deseasoned))

```

> Answer: The Mann Kendall test is kind of similar in result. The p-value is more statistically significant than before as it is lower than 0.05 at 0.0075, the tau value (ie correlation) rises is -0.165 which is similar to the result in qn 12implying a slight negative correlation, but the S score is much higher in magnitdue than before, implying a strong negative trend.