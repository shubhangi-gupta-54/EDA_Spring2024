...
```{r DataExercise-1a}
High_Temperature_F <- c(52, 34, 41, 49, 56, 65, 69, 69, 66, 62)
Low_Temperature_F <- c(21, 18, 18, 29, 46, 57, 58, 58, 51, 42)
Temperature_F <- data.frame(High_Temperature_F, Low_Temperature_F)
Temperature_F
```
...
```{r DataExercise-1b}
Temperature_C_func <- function(x){
  C <- (x-32)*(5/9)
  return(C)
}
High_Temperature_C<-Temperature_C_func(High_Temperature_F)
Low_Temperature_C <- Temperature_C_func(Low_Temperature_F)
Temperature_C <- data.frame(High_Temperature_C, Low_Temperature_C)
Temperature_C
```
...
```{r DataExercise-1c}
Temperature_F_C <- data.frame(Temperature_F, Temperature_C)
Temperature_F_C
Summary(Temperature_F_C)
```
