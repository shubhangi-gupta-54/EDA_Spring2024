...
Brief notes:
  - "E\_" are estimates; "M\_" are margins of error
  - "EP\_ are estimates, in percentages - "SPL_THEME1" is sum of series
...
#Select intersecting counties using the `filter()` command **UPDATED**
